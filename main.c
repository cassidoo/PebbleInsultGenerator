...
int length3 = sizeof(thirdblow)/sizeof(char); 
int length4 = sizeof(finalblow)/sizeof(char); 

char* genInsult()
{
	return initialblow[rand() % length1] + ", thou " + secondblow[rand() % length2] + " " + thirdblow[rand() % length3] + " " + finalblow[rand() % length4] + ".";
}
